...
def get_fundamental_matrix(P1, P2):
    ...
    points1 = np.zeros((n_pts, 2))
    points2 = np.zeros((n_pts, 2))
...
def get_homography_matrix(H1, H2):
    """
        finds the homography matrix between two views
    :param H1: {3x3} projection matrix
    :param H2: {3x3} projection matrix
    :return:
    """
    points3d = np.array([
        [100, 100, 1],

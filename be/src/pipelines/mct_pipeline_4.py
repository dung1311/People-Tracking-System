...
Flow per frame:
  ...
  4. GlobalTrackManagerV4 assigns global IDs via ReID + allocation.
...
from mct import CrossCameraClusterer, GlobalTrackManagerV4
...
class MCTPipeline4:
    ...
    def __init__(self, sct_config: dict, mct_config_path: str):
        ...
        self.global_manager = GlobalTrackManagerV4(
        ...
        self._output_video = out_cfg.get("video", "outputs/mct_output_v4.mp4")
        self._output_txt = out_cfg.get("txt_dir", "outputs/txt_v4")

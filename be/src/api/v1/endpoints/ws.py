...
async def websocket_session_stream(websocket: WebSocket, session_id: int):
    await websocket.accept()
    logger.info(f"WebSocket client connected to stream Session {session_id}")
    ...
    mgr.register_ws_callback(session_id, on_session_event)
    ...
    try:
        ...
        mgr.deregister_ws_callback(session_id, on_session_event)
        try:
